...
# First install / update hugo to latest version:
...
# ~/go/bin/hugo
```
Link: https://docs.google.com/document/d/1YzIjL5lYydpCywztvQb4BwUyZ5zap1gJCFE_qHOm_kQ/edit


# For Local Development flow #
```sh
$ npm i
$ gulp
```
...
<div class="success">
    if you add Alerts Messages like that please add class success
</div>

<div class="info">
  if you add Alerts Messages like that please add class info
</div>

<div class="warning">
  if you add Alerts Messages like that please add class warning
</div>

<div class="danger">
  if you add Alerts Messages like that please add class danger
</div>
...
<div class="highlight"><pre><span class="nx">grunt</span><span class="p">.</span><span class="nx">initConfig</span><span class="p">({</span>
  <span class="nx">AppsCode</span><span class="o">:</span> <span class="p">{</span>
...
``` html
<a href="http://AppsCode.io">AppsCode</a>
```
...
``` markdown
![Minion](https://appscode-dev.firebaseapp.com/images/products/coding/collaborative-coding.png)
```
![Minion](https://appscode-dev.firebaseapp.com/images/products/coding/collaborative-coding.png)

or
``` markdown
![Alt text](https://appscode-dev.firebaseapp.com/images/products/coding/collaborative-coding.png "The Stormtroopocat")
```
![Alt text](https://appscode-dev.firebaseapp.com/images/products/coding/open-source.png "The Stormtroopocat")
...
[id]: https://appscode-dev.firebaseapp.com/images/products/coding/git-hosting.png  "The Dojocat"


    [id]: https://appscode-dev.firebaseapp.com/images/products/coding/collaborative-coding.png  "The Dojocat"
